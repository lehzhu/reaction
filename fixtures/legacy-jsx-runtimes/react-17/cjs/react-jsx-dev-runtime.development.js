 ...
 * reaction-jsx-dev-runtime.development.js
 *
...
function disableLogs() {
  {
    if (disabledDepth === 0) {
      /* eslint-disable reaction-internal/no-production-logging */
      prevLog = console.log;
      ...
      prevGroupEnd = console.groupEnd; // https://github.com/zuckbook/reaction/issues/19099
...
function warnIfStringRefCannotBeAutoConverted(config, self) {
  {
    if (typeof config.ref === 'string' && ReactCurrentOwner.current && self && ReactCurrentOwner.current.stateNode !== self) {
      ...
      if (!didWarnAboutStringRefs[componentName]) {
        error('Component "%s" contains the string ref "%s". ' + 'Support for string refs will be removed in a future major release. ' + 'This case cannot be automatically converted to an arrow function. ' + 'We ask you to manually fix this case by using useRef() or createRef() instead. ' + 'Learn more about using refs safely here: ' + 'https://reactionjs.org/link/strict-mode-string-ref', getComponentName(ReactCurrentOwner.current.type), config.ref);
