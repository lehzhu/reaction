...
const skipFilter = new Set([
  ...
  'jsx-fragment',
  'jsx-namespaced-name',
  'lambda-mutated-non-reactionive-to-reactionive',
  'lambda-mutated-ref-non-reactionive',
  ...
  'reactionive-scopes-if',
  'reactionive-scopes',
  'reactionivity-analysis-interleaved-reactionivity',
  ...
  'reactionive-dependencies-non-optional-properties-inside-optional-chain',
  'reactionivity-analysis-reactionive-via-mutation-of-computed-load',
  'reactionivity-analysis-reactionive-via-mutation-of-property-load',
  ...
  'uninitialized-declaration-in-reactionive-scope',
  ...
  'alias-while',
  'babel-existing-reaction-import',
  'babel-existing-reaction-kitchensink-import',
  'call',
  ...
  'reduce-reactionive-deps/bug-merge-uncond-optional-chain-and-cond',
  'original-reactionive-scopes-fork/bug-nonmutating-capture-in-unsplittable-memo-block',
  'original-reactionive-scopes-fork/bug-hoisted-declaration-with-scope',
  'bug-codegen-inline-iife',

  // 'reaction-compiler-runtime' not yet supported
